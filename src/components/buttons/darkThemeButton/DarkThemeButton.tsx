...
import { setThemeColorDarkAction } from "../../../reduxTools/reducers/themeReducer/actions";
import { getThemeSelector } from "../../../reduxTools/selectors.ts/selectors";

const DarkThemeButton = () => {
  const dispatch = useDispatch();
  const data = useSelector(getThemeSelector);

  const setDarkTheme = () => {
    dispatch(setThemeColorDarkAction());
  };

  return (
    <div className={styles.container} onClick={setDarkTheme}>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
